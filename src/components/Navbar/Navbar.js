...
const Navbar = (props) => {
  ...
  async function handleLogout() {
    ...
    try {
      const response = await axios.get(
        "https://survey-rbq3.onrender.com/api/v1/logout"
      ); //making get request to do user logout
  ...
  return (
    <>
      <div>
        <nav class="navbar navbar-expand-lg bg-body-tertiary m-0 p-0  w-100 z-3 position-fixed">
          <div class="container-fluid bg-info">
            <a class="navbar-brand h4" href="/">
              <i class="fa-solid fa-earth-americas  ms-2 me-1"></i>SurveySphere
            </a>
            <button
